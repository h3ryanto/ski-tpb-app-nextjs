...
const AddBarangJadi: React.FC<AddBarangJadiProps> = ({ onAddDataSuccess }) => {
    ...
    const formAction = async (formData: FormData) => {
        ...
        if (!validatedFields.success) {
            ...
            setIsLoading(true)
            const result = await fetch('/api/save-barang-jadi', {
                method: 'POST',
                body: barangJadiData,
            });
        ...
        <>
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogTrigger asChild>
                    <Button size={'sm'} onClick={() => setOpen(true)}><PackagePlus /></Button>
                </DialogTrigger>
